...
//   console.log('[assessment.js] id =', id); // 新增打印
//   if (id === 'LOCAL') {
...
//   const { id } = req.params; // 新增解构
//   console.log('[report.js 2] id =', id); // 新增打印
//   if (id === 'LOCAL') {
//     return res.status(400).json({ error: "assessment.js 2:LOCAL is for preview only" });
//   }
//
//   try {
...
//   try {
//     const { role, patientId, content, recommendation, answers } = req.body;
