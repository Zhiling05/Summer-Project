    ...
    <>
      ...
      <div
        style={{
          ...
          width: '100vw',
          marginLeft: 'calc(-50vw + 50%)',
          minHeight: 'calc(100vh - 64px)', // 减去底部导航栏高度
          boxSizing: 'border-box',
          display: 'flex',
          alignItems: 'center', 
          justifyContent: 'center', 
          ...
          <div style={{
            ...
            >
              <div className="card-content">
                <h2 className="card-title card-title--with-description">
                  Reference Image Gallery
                </h2>
                <p className="card-description">
                  Visual references and diagnostic imaging examples for assessment
                </p>
              </div>
