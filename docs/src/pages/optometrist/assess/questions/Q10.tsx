...
=======
// docs/src/pages/optometrist/assess/questions/Q10.tsx
...
const Q10 = () => {
  ...
  /* ---------- 题干与选项 ---------- */
  const question =
    "Does the patient have binocular double vision (disappears when closes either eye)?";
  const opts = ["Yes", "No"];

  /* ---------- 跳转表 ---------- */
  const flowEntry = useMemo(
    () => (flow as FlowEntry[]).find((f) => f.id === "Q10"),
    []
  );
