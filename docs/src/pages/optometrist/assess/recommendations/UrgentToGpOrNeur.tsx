...
export default function UrgentToGpOrNeur() {
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <section className="question-box" style={{ 
            ...
            >
              Urgent Referral to GP or Neurology
            </h1>
            <p>
              The patient requires urgent referral. Please refer them to a General Practitioner (GP) or directly to Neurology if needed.
            </p>
