...
/** Human-readable text for each referral result */
...
/** Risk category mapping to high/medium/low levels */
...
/**
 * AdminDashboard - Admin console for reviewing all assessments
 * - Supports filtering by time period
 * - Provides two view modes: risk-level summary and referral-type summary
 */
export default function AdminDashboard() {
  ...
  const [viewMode, setViewMode] = useState<ViewMode>("risk-level");
  ...
  /** Quick set time filter by number of days */
  ...
  const resetFilters = () => {
    setFrom(""); setTo(""); setFromDate(null); setToDate(null);
  };
